...
namespace RehberlikSistemi.Web.Tests
{
    public class StudentControllerTests
    {
        ...
        public StudentControllerTests()
        {
            ...
            _mockUserManager.Object.UserValidators.Add(new UserValidator<ApplicationUser>());
            _mockUserManager.Object.PasswordValidators.Add(new PasswordValidator<ApplicationUser>());
        ...
        public async Task AddAvailability_UserNotFound_ReturnsNotFound()
        {
            ...
            var controller = new StudentController(dbContext, _mockUserManager.Object);
